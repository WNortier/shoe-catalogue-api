...
insert into stock (brand_id, color_id, size_id, price, quantity, image_id) values (1, 1, 1, 999, 3, 1);
insert into stock (brand_id, color_id, size_id, price, quantity, image_id) values (2, 2, 2, 799, 3, 6);
insert into stock (brand_id, color_id, size_id, price, quantity, image_id) values (3, 3, 3, 899, 3, 11);
insert into stock (brand_id, color_id, size_id, price, quantity, image_id) values (4, 4, 4, 999, 3, 16);